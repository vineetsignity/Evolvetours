<?php
	...
	$this->Html->addCrumb('Edit Guide',  '', array('class' => 'crumb-trail')) ;
?>
<div id="content">
	<div class="row">
		<div class="col-md-9">
			<div class="panel">
				<div class="panel-heading">
					<span class="panel-title">Edit Guide</span>
				</div>
				<div class="panel-body">
					...
					?>
								...
								<div class="input-group">
									<div class="radio-custom radio-primary mb5">
										<?php echo $this->Form->input('', array(
											...
											'value'=>''.$this->request->data['Guide']['gender'].'',
											'div'=>false,
											'legend'=>false
										)); ?>
									</div>								
						...
						<div class="form-group">							
							...
							?><div class="col-lg-9">								
								<?php 
								if(isset($this->data['Guide']['profile_image']) && !empty($this->data['Guide']['profile_image'])){
									echo $this->Html->image('../'.$this->data['Guide']['profile_image'], array(
										'class'=>'img-responsive',
										'height'=>'100px',
										'width'=>'100px'
									));
								}
								echo $this->Form->file('profile_image', array(
									'label'=>false,
									'div'=>false,
									'required'=>false, 
									'class'=>'',
			...
			<aside class="tray tray-left pn va-t" data-tray-height="match" style="height:auto!important;">
				<div class="p10">
                        ...
                        <ul class="nav nav-messages p5" role="menu">
							<li><?php echo $this->Form->postLink(__('<span class="fa fa-remove pr5"></span> Delete'), array('action' => 'delete', $this->Form->value('Guide.id')), array(
								'class'=>'fw600 p10 animated animated-short fadeInDown',
								'escape'=>false,
								), __('Are you sure you want to delete # %s?', $this->Form->value('Guide.id'))); ?></li>
