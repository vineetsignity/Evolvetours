			...
			<div class="panel">
				...
				<div class="panel-body">
						...
						echo $this->Form->create('School', 
							array(
								'class'=>'form-horizontal dropzone dropzone-sm',
								'role'=>'form',
				...
				<div class="p10">
                        ...
                        <ul class="nav nav-messages p5" role="menu">
							<li><?php echo $this->Html->link('<span class="fa fa-user pr5"></span> List Schools', 
								...
								<li><?php echo $this->Form->postLink(__('<span class="fa fa-remove pr5"></span> Delete'), array('action' => 'delete', $this->Form->value('School.id')), array(
									'class'=>'fw600 p10 animated animated-short fadeInDown',
									'escape'=>false,
								), __('Are you sure you want to delete # %s?', $this->Form->value('School.id'))); ?></li>
                        </ul>
				</div>
			</aside>
		</div>
