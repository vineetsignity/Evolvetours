...
$this->Html->addCrumb('Add User',  '', array('class' => 'crumb-trail')) ;
?>
<div id="content">
	<div class="row">
		<div class="col-md-8">
			...
			<aside class="tray tray-left pn va-t" data-tray-height="match" style="height:auto!important;">
				<div class="p10">
                        ...
                        <ul class="nav nav-messages p5" role="menu">
							...
							<!-- <li><?php echo $this->Html->link(__('<span class="fa fa-user pr5"></span> List Roles'), array('controller' => 'roles', 'action' => 'index'), array(
								'class'=>'fw600 p10 animated animated-short fadeInDown',
								'escape'=>false,
							)); ?> </li>
							<li><?php echo $this->Html->link(__('<span class="fa fa-user pr5"></span> New Role'), array('controller' => 'roles', 'action' => 'add'), array(
								'class'=>'fw600 p10 animated animated-short fadeInDown',
								'escape'=>false,
							)); ?> </li>-->
                        </ul>
