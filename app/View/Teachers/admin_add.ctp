<?php
	...
	$this->Html->addCrumb('Add New Teacher',  '', array('class' => 'crumb-trail')) ;
?>
<div id="content">
	<div class="row">
		<div class="col-md-9">
			<div class="panel">
				<div class="panel-heading">
					<span class="panel-title">Add New Teacher</span>
				</div>
				<div class="panel-body">
					<?php echo $this->Form->create('Teacher', array('class'=>'form-horizontal dropzone dropzone-sm', 'role'=>'form', 'enctype'=>'multipart/form-data')); ?>
						<div class="form-group">
							<?php 								
								echo $this->HTML->tag('label', 'Select User', array(
											'class' => 'col-lg-3'
										));
